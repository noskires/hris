	<?php 
		...
		foreach($separation_type as $data_separation)
		{
			for($year_separated =2007; $year_separated<= 2017; $year_separated++)
			{
				...
				$total_count_separation_per_year_separated .= $emp_count_pers_year_separated[$year_separated].","; 
				$years_label .= '"'.$year_separated.'",';
			}
		} 
        ...
        <!-- <div class="row tile_count">
          ...
          <div class="animated flipInY col-md-4 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="right">
              ...
              <span class="count_bottom red"> As of 01/12/2017 09:19 AM </span>| Total Average :<span class="count_bottom red"><b> <?php echo number_format($total_average/$total_active_emp ,2);?></b> </span>
            </div>
          </div>
        ...
        <!-- /top tiles -->
          ...
          <div class="row"> 
			...
			<div class="col-md-6 col-sm-6 col-xs-12">  
			  <div class="x_panel">
                <div class="x_title">
                  <h2>Personnel Classification	</h2>
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li class="dropdown">
		...
		var lineChart = new Chart(ctx, {
		  ...
		  data: { 
			...
			datasets: [{
			  ...
			  pointBorderWidth: 1, 
			  data: [<?php echo $total_count_separation_per_year_separated;?>]
		...
		<?php 
			foreach($separation_type as $seq_no => $data_separation)
			{
				?>{
					...
					{
					  label: '<?php echo trim($data_separation->termination_reason);?>',
					  backgroundColor: "<?php echo $colors[10];?>",
		...
		<?php 
			foreach($separation_type as $seq_no => $data_separation)
			{
				?>{
					...
					{
					  label: '<?php echo trim($data_separation->termination_reason);?>',
					  backgroundColor: "<?php echo $colors[4];?>",
		...
		<?php 
			foreach($separation_type as $seq_no => $data_separation)
			{
				?>
					{
					  label: '<?php echo trim($data_separation->termination_reason);?>',
					  backgroundColor: "<?php echo $colors[5];?>",
		...
		<?php 
			foreach($separation_type as $seq_no => $data_separation)
			{
				?>
					{
					  label: '<?php echo trim($data_separation->termination_reason);?>',
					  backgroundColor: "<?php echo $colors[9];?>",
