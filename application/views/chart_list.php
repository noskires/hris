    ...
    var lineChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          label: "Separated",
          backgroundColor: "rgba(253, 187, 26, 0.6)",
          borderColor: "rgba(3, 88, 106, 0.70)",
          pointBorderColor: "rgba(3, 88, 106, 0.70)",
          pointBackgroundColor: "rgba(3, 88, 106, 0.70)",
          pointHoverBackgroundColor: "#fff",
    ...
    var mybarChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
		{
          ...
          backgroundColor: "#1BD035",
          data: [<?php echo $location_data_gmm;?>]
          // data: [51, 30, 40, 28]
        }, 
		{
          label: 'Regional',
          backgroundColor: "#490B8D",
...
responsive: true
    ...
    var data = {
      labels: [ 
		<?php echo $termination_labels;?>
      ],
      datasets: [{
        data: [<?php echo $termination_cnts;?>],
    ...
    var canvasDoughnut = new Chart(ctx, {
	 ...
	 // Group data
    var ctx = document.getElementById("group_org_data"); 
    var data = {
      datasets: [{
