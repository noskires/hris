<?php  
		...
		foreach($get_count_per_separation_reason_per_year  as $separation)
		{ 
			
			$separation_data[trim($separation->termination_reason)][$separation->year_separated] = $separation->cnt; 
		}
		...
		foreach($get_separation_type as $sep_type)
		{
			for($i = 2007;$i<= 2016;$i++)
			{
				if(!isset($separation_data[trim($sep_type->termination_reason)][$i]))
				{ 
					$separation_data[trim($sep_type->termination_reason)][$i] = 0; 
				} 
				
				
				$data_per_sep_reason_per_year1[trim($sep_type->termination_reason)] .=  $separation_data[trim($sep_type->termination_reason)][$i].","; 
			}
		}
        ...
        <div class="">
          ...
          <div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Distribution By Separation</h2>
          ...
          <div class="row">
			<div class="col-md-12 col-sm-6 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <canvas id="dist_per_sep_emp_class" ></canvas>
				</div>
              </div>
            </div>
		  </div>
				 ...
				 foreach($get_separation_type as $count=>$sep_type)
				  {
					  ...
					  pointBorderWidth: 1,
					  data: ['.$data_per_sep_reason_per_year1[trim($sep_type->termination_reason)].']  
					}, ';  
