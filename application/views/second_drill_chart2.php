           ...
           <div class="col-md-12 col-sm-12 col-xs-12">
              <h3>
                   Organization
						...
						<select class="form-control group" id = "first_drill2" onChange="first_drill2();">
							...
							{
								?>
								<select class="form-control group" id = "second_drill2" onChange="second_drill2();" style="margin-top:2px;">
								<option value="">  All </option> 
								<?php 
							...
							{
								?>
								<select class="form-control group" id = "third_drill2" onChange="third_drill2();" style="margin-top:2px;">
								<option value="">  All </option> 
								<?php 
									foreach($drill2 as $row)
									{
										if($param3 == $row->third_level)
										{
											$selected = "selected=selected";
											?> 
											<option selected value="<?php echo $row->thrid_level;?>">  <?php echo $row->third_level_txt; ?> </option> 
											<?php
										}
										else
										{
