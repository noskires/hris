        ...
        <div class="row tile_count">
          ...
          <div class="animated flipInY col-md-4 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="right">
              ...
              <div class="count blue">6,747</div>
              <span class="count_bottom red">  As of 04/08/2016</span>
            </div>
          </div>
         <div class="animated flipInY col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="right">
              ...
              <div class="count green">52</div> 
			    Average age : <span class="count_bottom red">51.61</span>
            </div>
          </div>
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <div class="left"></div>
            <div class="right">
              ...
              <div class="count green">418</div>  
			  Average age : <span class="count_bottom red">47.09</span>  
            </div>
          </div>
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <div class="left"></div>
            <div class="right">
              ...
              <div class="count green">5,147</div> 
			  Average age : <span class="count_bottom red">45.71</span>
            </div>
          </div>
          <div class="animated flipInY col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            <div class="left"></div>
            <div class="right">
              ...
              <div class="count green">1,130</div>
              Average age : <span class="count_bottom red">42.11</span>
            </div>
          </div> 
        </div>
        <!-- /top tiles -->
  ...
  <div id="custom_notifications" class="custom-notifications dsp_none">
	...
	<script src="<?php echo base_url();?>assets/js/pace/pace.min.js"></script>
		...
		var mybarChart = new Chart(ctx, {
		  type: 'bar',
		  data: {
			labels: ['OCEO', 'Audit', 'Technology', 'Bus Analytics', 'EICB', 'Home', 'Asset Protection', 'BTO', 'CSAG', 'Finance', 'HR'],
			datasets: [
