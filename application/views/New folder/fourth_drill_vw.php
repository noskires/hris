    ...
    <body> 
		...
		{
			?>
			<select class="form-control group" id = "second_drill4" onChange="second_drill4();">
			<option value="">  All </option> 
			<?php 
		...
		{
			?>
			<select class="form-control group" id = "third_drill4" onChange="third_drill4();">
			<option value="">  All </option> 
			<?php 
		...
		{
			?>
			<select class="form-control group" id = "fourth_drill4" onChange="fourth_drill4();">
			<option value="">  All </option> 
			<?php 
