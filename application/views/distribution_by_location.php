                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
						<?php 
							//' get count per subgroup 
								...
								foreach($sex as $sex_data)
								{
									...
									$total_per_subgroup_per_sex  += $emp_count_sex[$sex_data];
							 
							?>
							<tr> 
								<th scope="row"> <?php echo $sex_data;?></th>
								<td align="right"> <?php echo $emp_count_sex[$sex_data];?></td> 
						...
						<tr> 
							...
							<td align="right"> <?php echo $total_per_subgroup_per_sex;?></td> 
						</tr> 
                    </tbody>
                  </table>
                </div>
                ...
                <div class="x_content">
                    ...
                    <tbody>
						<?php 
							...
							?>
							<tr> 
								<th scope="row"> <?php echo $pers_area_data;?></th>
								<?php 
